...
public:
    void set()
    {
        cout << "\n\n\t\tNOTE:\t * For Saving AccountInitial Amount Must Be Greater Than 3000 .\n\t\t\t * For Current Account Initial Amount Must Be Greater Than 10000 ";
    ...
    void setwithdraw(int n)
    {
        if (actype == 's' || actype == 'S')
        {
            ...
            if ((bal - n) < 3000)
            {
                cout << "Sorry, Left Amount Must Be Greater Than 3000" << endl;
            }
            else
            {
                bal -= n;
        ...
        else
        {
            if ((bal - n) < 10000)
            {
                cout << "Sorry, Left Amount Must Be Greater Than 10000" << endl;
            }
            else
            {
                bal -= n;
    ...
    void balupdate()
    {
        ...
        if (actype == 'c' || actype == 'C' || actype == 's' || actype == 'S')
        {
            ...
            else /*if (a == 's' || a == 'S')*/
            {
                if (bal <= 3000)
                {
                    cout << "\n\t\t\t\tInitial amount Must be Greater than 3000" << endl;
                    exit(0);
                }
            }
        }
...
int main()
{
    ...
    else if (i == 2)
    {
        ...
        int r, vpin;
        f.open("atishay1", ios::in | ios::out);
        f.seekg(0, ios::end);
        int p = f.tellg();
        int num = p / sizeof(b1);
        if (num <= 0)
        {
            ...
            cout << "Thanks For Coming To The ATISHAY's Bank" << endl;
        }
        else
        {
            system("CLS");
